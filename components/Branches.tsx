  ...
  const branches: Branch[] = [
    {
      id: "Дүнжингарав",
      name: "Дүнжингарав",
      address: "БЗД, 26-р хороо, Санни Таун хотхон, 1-р давхарт, Улаанбаатар хот, Монгол улс",
      district: "Баянзүрх",
      lat: 47.9041,
      lng: 106.9393,
      hours: "08:00-24:00",
    ...
    },
    {
      id: "4-р хороолол",
      name: "4-р хороолол",
      address: "БГД, 8-р хороо, 4-р хороолол, Pearl Apartment\" орон сууцны 1 давхар, Улаанбаатар хот, Монгол улс",
      district: "Баянгол",
      lat: 47.9214,
      lng: 106.8703,
      hours: "08:00-24:00",
    ...
    },    
    {
      id: "Яармаг",
      name: "Яармаг",
      address: "ХУД, 4-р хороо, Наадамчдын гудамж, Food City худалдааны төв, Улаанбаатар хот, Монгол улс",
      district: "Хан-Уул",
      lat: 47.9214,
      lng: 106.8703,
      hours: "08:00-24:00",
    ...
    },
    {
      id: "1-р Хороолол",
      name: "1-р Хороолол",
      address: "БГД, 20-р хороо, Улаанбаатар хот, Монгол улс",
      district: "Баянгол",
      lat: 47.9113,
      lng: 106.8177,
      hours: "08:00-24:00",
    ...
    },
    {
      id: "Баянцээл",
      name: "Баянцээл",
      address: "Сансар Баянцээлийн туслахаар дээш өгсөөд МОБИКОМ, ЮНИТЕЛ-ийн хажууд, 2-р байр, 7-р Хороо, Баянзүрх дүүрэг, Улаанбаатар хот, Монгол улс",
      district: "Баянзүрх",
      lat: 47.9225,
      lng: 106.9338,
      hours: "08:00-24:00",
    ...
    },
    {
      id: "Шархад - ДХИС",
      name: "Шархад - ДХИС",
      address: "БЗД, 8-р хороо, Шар хад-1, Хилчний гудамж, 121-р байр, 101 тоот, Улаанбаатар хот, Монгол улс",
      district: "Баянзүрх",
      lat: 47.9175,
      lng: 106.9925,
      hours: "08:00-24:00",
